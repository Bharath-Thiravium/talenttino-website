...
CREATE TABLE IF NOT EXISTS site_settings (
    ...
    instagram_url VARCHAR(255) DEFAULT 'https://www.instagram.com/talentteno__/',
    linkedin_url VARCHAR(255) DEFAULT 'https://www.linkedin.com/search/results/companies/?keywords=Talentteno%20Institute',
...
SET instagram_url = 'https://www.instagram.com/talentteno__/'
WHERE id = 1
  AND (
    instagram_url IS NULL
    OR TRIM(instagram_url) = ''
    OR TRIM(instagram_url) = '#'
    OR LOWER(TRIM(TRAILING '/' FROM instagram_url)) IN (
      'talentteno_',
      '@talentteno_',
