...
<head>
    ...
    <link rel="stylesheet" href="assets/css/site-pages.min.css?v=20260723-aichatalign1">
    <style>
        ...
        html body.home-page .home-ai-suggestions{display:grid!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:9px!important;padding:10px 12px 0!important;background:#fff!important}
        html body.home-page .home-ai-suggestions button{width:100%!important;min-width:0!important;min-height:36px!important;padding:0 10px!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important}
        ...
        @media(max-width:520px){html body.home-page .home-ai-chat{right:12px!important;bottom:14px!important}html body.home-page .home-ai-panel{left:10px!important;right:10px!important;bottom:78px!important;width:auto!important;max-height:calc(100dvh - 96px)!important;border-radius:16px!important;grid-template-rows:auto minmax(120px,1fr) auto auto!important}html body.home-page .home-ai-head{min-height:62px!important;padding:10px!important;grid-template-columns:38px minmax(0,1fr) 38px!important}html body.home-page .home-ai-head .home-ai-back,html body.home-page .home-ai-head .home-ai-close{width:38px!important;height:38px!important;min-width:38px!important}html body.home-page .home-ai-suggestions{grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:8px!important;padding:9px 10px 0!important}html body.home-page .home-ai-form{grid-template-columns:minmax(0,1fr) 52px!important;padding:10px!important}html body.home-page .home-ai-form input{height:46px!important}html body.home-page .home-ai-form button{width:52px!important;height:46px!important;min-width:52px!important}}
        @media(max-height:560px){html body.home-page .home-ai-panel{max-height:calc(100dvh - 84px)!important;bottom:70px!important}html body.home-page .home-ai-head{min-height:58px!important}html body.home-page .home-ai-suggestions button{min-height:32px!important}html body.home-page .home-ai-form input,html body.home-page .home-ai-form button{height:42px!important}}
    </style>
</head>
...
<div class="site-shell">
    <header class="site-header">
        <div class="site-container nav-wrap">
            ...
            <nav class="site-nav">
                ...
                <div class="nav-item has-menu"><a href="course.php">Course <i class="fa-solid fa-chevron-down"></i></a><div class="nav-menu"><a class="nav-menu-rich-link" href="shorttermcourse.php"><i class="fa-solid fa-clock" aria-hidden="true"></i><span>Short Term Course</span></a><a class="nav-menu-rich-link" href="popularcourse.php"><i class="fa-solid fa-fire" aria-hidden="true"></i><span>Popular Course</span></a><a class="nav-menu-rich-link" href="advancecourse.php"><i class="fa-solid fa-layer-group" aria-hidden="true"></i><span>Advance Course</span></a><a class="nav-menu-rich-link" href="designingcourse.php"><i class="fa-solid fa-pen-nib" aria-hidden="true"></i><span>Designing Course</span></a><a class="nav-menu-rich-link" href="cybersecuritycourse.php"><i class="fa-solid fa-shield-halved" aria-hidden="true"></i><span>Cyber Security</span></a></div></div>
                <a href="gallery.php">Gallery</a>
                <a href="contact.php">Contact</a>
                <div class="nav-item has-menu more-menu"><a href="#">Others <i class="fa-solid fa-chevron-down"></i></a><div class="nav-menu"><a class="nav-menu-rich-link" href="services.php"><i class="fa-solid fa-concierge-bell" aria-hidden="true"></i><span>Services</span></a><a class="nav-menu-rich-link" href="career.php"><i class="fa-solid fa-briefcase" aria-hidden="true"></i><span>Career</span></a><a class="nav-menu-rich-link" href="blog.php"><i class="fa-solid fa-newspaper" aria-hidden="true"></i><span>Blog</span></a><a class="nav-menu-rich-link" href="project.php"><i class="fa-solid fa-diagram-project" aria-hidden="true"></i><span>Project</span></a><a class="nav-menu-rich-link" href="review.php"><i class="fa-solid fa-star" aria-hidden="true"></i><span>Student Reviews</span></a><a class="nav-menu-rich-link" href="why-talentteno.php"><i class="fa-solid fa-graduation-cap" aria-hidden="true"></i><span>Why Talentteno</span></a><a class="nav-menu-rich-link" href="hiring.php"><i class="fa-solid fa-user-plus" aria-hidden="true"></i><span>Hiring</span></a><a class="nav-menu-rich-link" href="franchise.php"><i class="fa-solid fa-handshake" aria-hidden="true"></i><span>Franchise Enquiry</span></a></div></div>
            </nav>
    ...
    <div class="home-social-rail" aria-label="Talentteno social links">
        <a href="<?= tt_h($homeInstagramUrl) ?>" target="_blank" rel="noopener noreferrer" aria-label="Instagram"><i class="fa-brands fa-instagram"></i></a>
...
<script src="assets/js/site-pages.min.js?v=20260723-reviewauto4" defer></script>
</body>
</html>
