...
<head>
    ...
    <style>
        ...
        /* Final catalog alignment lock: keeps Popular/Advanced cards in one clean row rhythm. */
        html body.catalog-body .catalog-section{
        ...
        html body.catalog-body .catalog-grid>.catalog-card ul,
        html body.catalog-body .catalog-grid>.catalog-card .catalog-price{
            display:none!important;
        }
        html body.catalog-body .catalog-grid>.catalog-card .catalog-actions{
            position:static!important;
        ...
        @media (max-width:700px){
            ...
            html body.catalog-body .catalog-grid{
                width:min(calc(100vw - 30px),392px)!important;
                grid-template-columns:1fr!important;
                gap:18px!important;
            }
            html body.catalog-body .catalog-grid>.catalog-card,
        ...
        /* Absolute last catalog card alignment: same vertical rhythm on all course pages. */
        html body.catalog-body .catalog-grid{
        ...
        @media(max-width:1100px){
            html body.catalog-body .catalog-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important}
        }
        @media(max-width:700px){
            html body.catalog-body .catalog-grid{
                width:min(100% - 28px,420px)!important;
