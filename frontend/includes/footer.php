...
?>
<style>
html body .site-footer .footer-logo,html body.home-page .site-footer .footer-logo,html body.static-site .site-footer .footer-logo{grid-template-columns:132px minmax(0,1fr)!important;gap:8px!important;align-items:center!important}
html body .site-footer .footer-logo-mark,html body.home-page .site-footer .footer-logo-mark,html body.static-site .site-footer .footer-logo-mark{width:132px!important;height:132px!important;min-width:132px!important;padding:0!important;border:0!important;border-radius:0!important;background:transparent!important;box-shadow:none!important;overflow:visible!important;clip-path:none!important}
html body .site-footer .footer-logo-mark img,html body.home-page .site-footer .footer-logo-mark img,html body.static-site .site-footer .footer-logo-mark img{width:132px!important;height:132px!important;object-fit:contain!important;border:0!important;border-radius:0!important;background:transparent!important;box-shadow:none!important}
...
@media(max-width:760px){html body .site-footer .footer-logo,html body.home-page .site-footer .footer-logo,html body.static-site .site-footer .footer-logo{grid-template-columns:104px minmax(0,1fr)!important;gap:6px!important}html body .site-footer .footer-logo-mark,html body.home-page .site-footer .footer-logo-mark,html body.static-site .site-footer .footer-logo-mark,html body .site-footer .footer-logo-mark img,html body.home-page .site-footer .footer-logo-mark img,html body.static-site .site-footer .footer-logo-mark img{width:104px!important;height:104px!important;min-width:104px!important;background:transparent!important;border-radius:0!important;box-shadow:none!important;clip-path:none!important}html body .site-footer .footer-logo strong,html body.home-page .site-footer .footer-logo strong,html body.static-site .site-footer .footer-logo strong{font-size:clamp(27px,7vw,34px)!important}}
@media(max-width:420px){html body .site-footer .footer-logo,html body.home-page .site-footer .footer-logo,html body.static-site .site-footer .footer-logo{grid-template-columns:96px minmax(0,1fr)!important;gap:4px!important}html body .site-footer .footer-logo-mark,html body.home-page .site-footer .footer-logo-mark,html body.static-site .site-footer .footer-logo-mark,html body .site-footer .footer-logo-mark img,html body.home-page .site-footer .footer-logo-mark img,html body.static-site .site-footer .footer-logo-mark img{width:96px!important;height:96px!important;min-width:96px!important;background:transparent!important}}
</style>
<footer class="site-footer">
    <div class="site-container footer-grid">
        <div class="footer-brand-block">
            <a class="footer-logo" href="index.php">
                <span class="brand-mark footer-logo-mark"><img src="<?= tt_h(tt_asset_url('assets/images/logot-transparent.png')) ?>" alt="<?= tt_h($settings['site_name']) ?> logo" loading="lazy" decoding="async" width="132" height="132"></span>
