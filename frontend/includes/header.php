...
<link rel="stylesheet" href="assets/css/navbar.css?v=20260727-global-nav1">
<header class="site-header" id="site-header">
    <div class="nav-wrap">
        <a class="brand" href="index.php" aria-label="Talentteno Institute home">
            <span class="brand-mark logo-mark">
                <img src="uploads/optimized/logot-transparent-w128.webp" srcset="uploads/optimized/logot-transparent-w64.webp 64w, uploads/optimized/logot-transparent-w128.webp 128w" sizes="54px" alt="Talentteno Institute logo" width="54" height="54" decoding="async" fetchpriority="high">
            </span>
