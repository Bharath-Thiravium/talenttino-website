                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="content-current-image">
                            <img loading="lazy" decoding="async" src="<?= htmlspecialchars(tt_admin_content_image_url($edit_item['image'])) ?>" alt="">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <img loading="lazy" decoding="async" class="content-admin-thumb" src="<?= htmlspecialchars(tt_admin_content_image_url($item['image'])) ?>" alt="">
                                    <?php else: ?>
